...
while ch=='y':
    print(logo)
    x,y=random.choices(data,k=2)
    print("COMPARE")
    print(f"A){x['name']} a {x['description']} from {x['country']}")
    print(vs)
    ...
    if res==inp:
        ...
        print("Well both have equal followers so ig you won?")
    else:
        print("Sorry you lost")
    ch=input("Do you wanna play again?").lower()
print("\n","THANKYOU")
